# Resolved SeedSpec: College Football Dashboard — Intent Only
...
- Root package: org.seedspec.examples.college-football-dashboard-plain@0.2.0
- Root package digest: sha256:8af5c142c4aff9d82d1db87a42fc565a8cf60531e9c41fff43f9134b25db4653
...
- org.seedspec.examples.college-football-dashboard-plain: as-authored; `org.seedspec.intent.native` at `definition/college-football-dashboard.md` — The implementation request explicitly asks for the dashboard described by the assigned SeedSpec and directs use of its example configuration.

## Solution configuration

### College Football Dashboard — Intent Only (example)
...
### org.seedspec.examples.college-football-dashboard-plain
...
- complete-acceptance: all of org.seedspec.examples.college-football-dashboard-plain/acceptance; prove realization by tool-check at completion
...
- org.seedspec.examples.college-football-dashboard-plain/acceptance: components/org.seedspec.examples.college-football-dashboard-plain/acceptance/ — review before-completion-claim
...
- org.seedspec.examples.college-football-dashboard-plain/org.seedspec.guidance.context7-current-docs@0.1.0: instructions; available; exact
...
- org.seedspec.examples.college-football-tracking@1.0.0 — org.seedspec.examples.college-football-dashboard-plain@0.2.0
