...
- Area: 3 of 7 — Material ambiguity
...
6. Update the standardized pass result at `passes/0003-material-ambiguity/result.yaml` in the authoring workspace. Set `outcome: needs-author` while blocked on author judgment and `outcome: completed` only after validation.
...
Update `passes/0003-material-ambiguity/result.yaml` in the authoring workspace using its existing standardized fields.
