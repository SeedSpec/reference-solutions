...
- `authoring/` contains non-distributable audit history and open questions.
...
npx --yes @seedspec/cli@0.1.0-alpha.3 lint solutions/allowance-tracker/seedspec
npx --yes @seedspec/cli@0.1.0-alpha.3 begin solutions/allowance-tracker/seedspec
```

Inspect its authoring record without modifying it:
