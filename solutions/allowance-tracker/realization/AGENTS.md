...
When SeedSpec tooling is needed, invoke the pinned npm CLI as
`npx --yes @seedspec/cli@0.1.0-alpha.3`; do not assume a sibling protocol
checkout or global installation.
