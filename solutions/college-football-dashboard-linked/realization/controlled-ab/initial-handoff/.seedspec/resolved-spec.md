# Resolved SeedSpec: College Football Dashboard — Andromeda Link Only
...
- Root package: org.seedspec.examples.college-football-dashboard-linked@0.2.0
- Root package digest: sha256:21e569cb2b568c1112b6f0bf0292bff65389633c07eb93989fba083d79d377af
...
- org.seedspec.examples.college-football-dashboard-linked: as-authored; `org.seedspec.intent.native` at `definition/college-football-dashboard.md`
...
### College Football Dashboard — Andromeda Link Only (example)
...
### org.seedspec.examples.college-football-dashboard-linked
...
- **External AI Canvas Andromeda** (`andromeda-external`) — preferred: Use the externally published AI Canvas Andromeda design system and components as the preferred visual realization without carrying their source or design guidance in this package.
  - Preserved guidance: `implementation-profiles/org.seedspec.examples.college-football-dashboard-linked/andromeda-external/andromeda-external-profile.md`
...
- complete-acceptance: all of org.seedspec.examples.college-football-dashboard-linked/acceptance; prove realization by tool-check at completion
...
- org.seedspec.examples.college-football-dashboard-linked/acceptance: components/org.seedspec.examples.college-football-dashboard-linked/acceptance/ — review before-completion-claim
...
- org.seedspec.examples.college-football-dashboard-linked/org.seedspec.guidance.context7-current-docs@0.1.0: instructions; available; exact
...
- org.seedspec.examples.college-football-tracking@1.0.0 — org.seedspec.examples.college-football-dashboard-linked@0.2.0
