...
- Kind hint: `feature`
- Package digest before pass: `sha256:8e993b0b3b502c4f1266720854c84adfd673af7af1edb499e35becad5bafe75b`
...
6. Update the standardized pass result at `authoring-reviews/savings-goals/passes/0006-agent-ready-handoff/result.yaml`. Set `outcome: needs-author` while blocked on author judgment and `outcome: completed` only after validation.
...
Update `authoring-reviews/savings-goals/passes/0006-agent-ready-handoff/result.yaml` using its existing standardized fields.
